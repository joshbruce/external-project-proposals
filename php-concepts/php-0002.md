...
// There is no "false" variant for an object instance - therefore, null is used.
...
This similar sample, is checking if the instance believes itself to be in a `true` or `false` state.
...
Demonstrating internal consistency of scalar types.
